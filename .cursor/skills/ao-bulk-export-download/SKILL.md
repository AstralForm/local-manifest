...
Validate that none of the four values are empty after prompting (re-prompt if empty).
...
- Always end the Slack message with: `@acc-ops-seniors, please review the files before uploading.`
